...
#line	26	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
#include <stdio.h>
#include <string.h>
#include "awk.h"
...
#line	43	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
typedef union  {
	Node	*p;
	Cell	*cp;
	int	i;
...
#line	447	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
...
case 1:
#line	100	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ if (errorflag==0)
			winner = (Node *)stat3(PROGRAM, beginloc, yypt[-0].yyv.p, endloc); } break;
case 2:
#line	102	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyclearin; bracecheck(); SYNTAX("bailing out"); } break;
case 13:
#line	126	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{inloop++;} break;
case 14:
#line	127	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ --inloop; yyval.p = stat4(FOR, yypt[-9].yyv.p, notnull(yypt[-6].yyv.p), yypt[-3].yyv.p, yypt[-0].yyv.p); } break;
case 15:
#line	128	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{inloop++;} break;
case 16:
#line	129	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ --inloop; yyval.p = stat4(FOR, yypt[-7].yyv.p, NIL, yypt[-3].yyv.p, yypt[-0].yyv.p); } break;
case 17:
#line	130	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{inloop++;} break;
case 18:
#line	131	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ --inloop; yyval.p = stat3(IN, yypt[-5].yyv.p, makearr(yypt[-3].yyv.p), yypt[-0].yyv.p); } break;
case 19:
#line	135	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ setfname(yypt[-0].yyv.cp); } break;
case 20:
#line	136	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ setfname(yypt[-0].yyv.cp); } break;
case 21:
#line	140	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = notnull(yypt[-1].yyv.p); } break;
case 26:
#line	152	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.i = 0; } break;
case 28:
#line	157	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.i = 0; } break;
case 30:
#line	163	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = 0; } break;
case 32:
#line	168	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = 0; } break;
case 33:
#line	169	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = yypt[-1].yyv.p; } break;
case 34:
#line	173	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = notnull(yypt[-0].yyv.p); } break;
case 35:
#line	177	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat2(PASTAT, yypt[-0].yyv.p, stat2(PRINT, rectonode(), NIL)); } break;
case 36:
#line	178	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat2(PASTAT, yypt[-3].yyv.p, yypt[-1].yyv.p); } break;
case 37:
#line	179	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = pa2stat(yypt[-2].yyv.p, yypt[-0].yyv.p, stat2(PRINT, rectonode(), NIL)); } break;
case 38:
#line	180	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = pa2stat(yypt[-5].yyv.p, yypt[-3].yyv.p, yypt[-1].yyv.p); } break;
case 39:
#line	181	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat2(PASTAT, NIL, yypt[-1].yyv.p); } break;
case 40:
#line	183	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ beginloc = linkum(beginloc, yypt[-1].yyv.p); yyval.p = 0; } break;
case 41:
#line	185	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ endloc = linkum(endloc, yypt[-1].yyv.p); yyval.p = 0; } break;
case 42:
#line	186	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{infunc++;} break;
case 43:
#line	187	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ infunc--; curfname=0; defn((Cell *)yypt[-7].yyv.p, yypt[-5].yyv.p, yypt[-1].yyv.p); yyval.p = 0; } break;
case 45:
#line	192	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = linkum(yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 47:
#line	197	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = linkum(yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 48:
#line	201	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 49:
#line	203	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(CONDEXPR, notnull(yypt[-4].yyv.p), yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 50:
#line	205	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(BOR, notnull(yypt[-2].yyv.p), notnull(yypt[-0].yyv.p)); } break;
case 51:
#line	207	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(AND, notnull(yypt[-2].yyv.p), notnull(yypt[-0].yyv.p)); } break;
case 52:
#line	208	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(yypt[-1].yyv.i, NIL, yypt[-2].yyv.p, (Node*)makedfa(yypt[-0].yyv.s, 0)); } break;
case 53:
#line	210	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
...
case 54:
#line	214	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(INTEST, yypt[-2].yyv.p, makearr(yypt[-0].yyv.p)); } break;
case 55:
#line	215	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(INTEST, yypt[-3].yyv.p, makearr(yypt[-0].yyv.p)); } break;
case 56:
#line	216	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(CAT, yypt[-1].yyv.p, yypt[-0].yyv.p); } break;
case 59:
#line	222	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 60:
#line	224	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(CONDEXPR, notnull(yypt[-4].yyv.p), yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 61:
#line	226	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(BOR, notnull(yypt[-2].yyv.p), notnull(yypt[-0].yyv.p)); } break;
case 62:
#line	228	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(AND, notnull(yypt[-2].yyv.p), notnull(yypt[-0].yyv.p)); } break;
case 63:
#line	229	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 64:
#line	230	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 65:
#line	231	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 66:
#line	232	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 67:
#line	233	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 68:
#line	234	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 69:
#line	235	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(yypt[-1].yyv.i, NIL, yypt[-2].yyv.p, (Node*)makedfa(yypt[-0].yyv.s, 0)); } break;
case 70:
#line	237	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ if (constnode(yypt[-0].yyv.p))
			yyval.p = op3(yypt[-1].yyv.i, NIL, yypt[-2].yyv.p, (Node*)makedfa(strnode(yypt[-0].yyv.p), 0));
		  else
			yyval.p = op3(yypt[-1].yyv.i, (Node *)1, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 71:
#line	241	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(INTEST, yypt[-2].yyv.p, makearr(yypt[-0].yyv.p)); } break;
case 72:
#line	242	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(INTEST, yypt[-3].yyv.p, makearr(yypt[-0].yyv.p)); } break;
case 73:
#line	243	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ 
			if (safe) SYNTAX("cmd | getline is unsafe");
			else yyval.p = op3(GETLINE, yypt[-0].yyv.p, itonp(yypt[-2].yyv.i), yypt[-3].yyv.p); } break;
case 74:
#line	246	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ 
			if (safe) SYNTAX("cmd | getline is unsafe");
			else yyval.p = op3(GETLINE, (Node*)0, itonp(yypt[-1].yyv.i), yypt[-2].yyv.p); } break;
case 75:
#line	249	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(CAT, yypt[-1].yyv.p, yypt[-0].yyv.p); } break;
case 78:
#line	255	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = linkum(yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 79:
#line	256	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = linkum(yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 81:
#line	261	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = linkum(yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 82:
#line	265	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = rectonode(); } break;
case 84:
#line	267	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = yypt[-1].yyv.p; } break;
case 93:
#line	284	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(MATCH, NIL, rectonode(), (Node*)makedfa(yypt[-0].yyv.s, 0)); } break;
case 94:
#line	285	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op1(NOT, notnull(yypt[-0].yyv.p)); } break;
case 95:
#line	289	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{startreg();} break;
case 96:
#line	289	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.s = yypt[-1].yyv.s; } break;
case 99:
#line	297	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ 
			if (safe) SYNTAX("print | is unsafe");
			else yyval.p = stat3(yypt[-3].yyv.i, yypt[-2].yyv.p, itonp(yypt[-1].yyv.i), yypt[-0].yyv.p); } break;
case 100:
#line	300	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{
			if (safe) SYNTAX("print >> is unsafe");
			else yyval.p = stat3(yypt[-3].yyv.i, yypt[-2].yyv.p, itonp(yypt[-1].yyv.i), yypt[-0].yyv.p); } break;
case 101:
#line	303	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{
			if (safe) SYNTAX("print > is unsafe");
			else yyval.p = stat3(yypt[-3].yyv.i, yypt[-2].yyv.p, itonp(yypt[-1].yyv.i), yypt[-0].yyv.p); } break;
case 102:
#line	306	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat3(yypt[-1].yyv.i, yypt[-0].yyv.p, NIL, NIL); } break;
case 103:
#line	307	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat2(DELETE, makearr(yypt[-3].yyv.p), yypt[-1].yyv.p); } break;
case 104:
#line	308	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat2(DELETE, makearr(yypt[-0].yyv.p), 0); } break;
case 105:
#line	309	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = exptostat(yypt[-0].yyv.p); } break;
case 106:
#line	310	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyclearin; SYNTAX("illegal statement"); } break;
case 109:
#line	319	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ if (!inloop) SYNTAX("break illegal outside of loops");
				  yyval.p = stat1(BREAK, NIL); } break;
case 110:
#line	321	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat1(CLOSE, yypt[-1].yyv.p); } break;
case 111:
#line	322	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{  if (!inloop) SYNTAX("continue illegal outside of loops");
				  yyval.p = stat1(CONTINUE, NIL); } break;
case 112:
#line	324	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{inloop++;} break;
case 113:
#line	324	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{--inloop;} break;
case 114:
#line	325	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat2(DO, yypt[-6].yyv.p, notnull(yypt[-2].yyv.p)); } break;
case 115:
#line	326	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat1(EXIT, yypt[-1].yyv.p); } break;
case 116:
#line	327	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat1(EXIT, NIL); } break;
case 118:
#line	329	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat3(IF, yypt[-3].yyv.p, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 119:
#line	330	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat3(IF, yypt[-1].yyv.p, yypt[-0].yyv.p, NIL); } break;
case 120:
#line	331	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = yypt[-1].yyv.p; } break;
case 121:
#line	332	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ if (infunc)
				SYNTAX("next is illegal inside a function");
			  yyval.p = stat1(NEXT, NIL); } break;
case 122:
#line	335	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ if (infunc)
				SYNTAX("nextfile is illegal inside a function");
			  yyval.p = stat1(NEXTFILE, NIL); } break;
case 123:
#line	338	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat1(RETURN, yypt[-1].yyv.p); } break;
case 124:
#line	339	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = stat1(RETURN, NIL); } break;
case 126:
#line	341	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{inloop++;} break;
case 127:
#line	341	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ --inloop; yyval.p = stat2(WHILE, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 128:
#line	342	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = 0; } break;
case 130:
#line	347	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = linkum(yypt[-1].yyv.p, yypt[-0].yyv.p); } break;
case 133:
#line	355	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(DIVEQ, yypt[-3].yyv.p, yypt[-0].yyv.p); } break;
case 134:
#line	356	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(ADD, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 135:
#line	357	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(MINUS, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 136:
#line	358	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(MULT, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 137:
#line	359	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(DIVIDE, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 138:
#line	360	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(MOD, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 139:
#line	361	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(POWER, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 140:
#line	362	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op1(UMINUS, yypt[-0].yyv.p); } break;
case 141:
#line	363	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = yypt[-0].yyv.p; } break;
case 142:
#line	364	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op1(NOT, notnull(yypt[-0].yyv.p)); } break;
case 143:
#line	365	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(BLTIN, itonp(yypt[-2].yyv.i), rectonode()); } break;
case 144:
#line	366	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(BLTIN, itonp(yypt[-3].yyv.i), yypt[-1].yyv.p); } break;
case 145:
#line	367	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(BLTIN, itonp(yypt[-0].yyv.i), rectonode()); } break;
case 146:
#line	368	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(CALL, celltonode(yypt[-2].yyv.cp,CVAR), NIL); } break;
case 147:
#line	369	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(CALL, celltonode(yypt[-3].yyv.cp,CVAR), yypt[-1].yyv.p); } break;
case 148:
#line	370	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op1(PREDECR, yypt[-0].yyv.p); } break;
case 149:
#line	371	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op1(PREINCR, yypt[-0].yyv.p); } break;
case 150:
#line	372	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op1(POSTDECR, yypt[-1].yyv.p); } break;
case 151:
#line	373	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op1(POSTINCR, yypt[-1].yyv.p); } break;
case 152:
#line	374	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(GETLINE, yypt[-2].yyv.p, itonp(yypt[-1].yyv.i), yypt[-0].yyv.p); } break;
case 153:
#line	375	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(GETLINE, NIL, itonp(yypt[-1].yyv.i), yypt[-0].yyv.p); } break;
case 154:
#line	376	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(GETLINE, yypt[-0].yyv.p, NIL, NIL); } break;
case 155:
#line	377	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(GETLINE, NIL, NIL, NIL); } break;
case 156:
#line	379	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op2(INDEX, yypt[-3].yyv.p, yypt[-1].yyv.p); } break;
case 157:
#line	381	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ SYNTAX("index() doesn't permit regular expressions");
		  yyval.p = op2(INDEX, yypt[-3].yyv.p, (Node*)yypt[-1].yyv.s); } break;
case 158:
#line	383	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = yypt[-1].yyv.p; } break;
case 159:
#line	385	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op3(MATCHFCN, NIL, yypt[-3].yyv.p, (Node*)makedfa(yypt[-1].yyv.s, 1)); } break;
case 160:
#line	387	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
...
case 169:
#line	408	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
{ yyval.p = op4(yypt[-7].yyv.i, NIL, (Node*)makedfa(yypt[-5].yyv.s, 1), yypt[-3].yyv.p, yypt[-1].yyv.p); } break;
case 170:
#line	410	"/tmp/kwerc/vendor/9base/awk/awkgram.y"
